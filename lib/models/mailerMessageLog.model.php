...
//        $maxdate = $mindate + $campaign_dates['length'] + $campaign_dates['quantum'] * 60;
    ...
    public static function colorizeStatuses(&$log, $tag = 'span', $attrs = '')
    {
        $ot = '<' . $tag . ' ' . $attrs;
        $ct = '</' . $tag . '>';
        foreach ($log as &$l)
        {
            ...
            switch($l['status']) {
                ...
                case -1:
                    ...
                    $l['status_text'] = $ot . ' class="'.$css_class.'">' . htmlspecialchars($error) . $ct;
                    break;
                case 0:
                    $l['status_text'] = $ot . ' class="awaits-sending">' . _w('Not sent yet') . $ct;
                    break;
                case 1:
                case 2:
                ...
                case 3:
                case 4:
                    $l['status_text'] = $ot . ' class="opened">' . _w('Opened') . $ct;
                    break;
                case 5:
                    $l['status_text'] = $ot . ' class="unsubscribed">' . _w('Unsubscribed ') . $ct;
                    break;
            }
        }
        unset($l);
